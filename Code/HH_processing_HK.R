...
library(readxl)
library(stringr)
library(lubridate) # MARISSA added this package

# Set working directory - UPDATE FOR EACH USER
setwd("~/Desktop/ARMS analysis/SW-Madagascar")

# Load utilities
source("~/Desktop/ARMS analysis/SW-Madagascar/Code/HH_utils.R")
...
# File locations
dd_file = "Data Dictionary/HH_DataDictionary.xlsx" ## (Question for Emma: do we need to update this for each user?)

# MARISSA changed paths
list_files = c("HHData/Raw/F1F2/madeleine_hh_april.xlsx", "HHData/Raw/F1F2/eric_hh_april.xlsx", "HHData/Raw/F1F2/marc_hh_april.xlsx", 
               "HHData/Raw/F1F2/romario_hh_april.xlsx", "HHData/Raw/F1F2/andrea_hh_april.xlsx")
...
dd_file = "Data Dictionary/HH_DataDictionary.xlsx"

list_files = c("HHData/Raw/F3/madeleine_hh_0723.xlsx", "HHData/Raw/F3/eric_hh_0723.xlsx", "HHData/Raw/F3/marc_hh_0723.xlsx", 
               "HHData/Raw/F3/romario_hh_0723.xlsx", "HHData/Raw/F3/mahefa_hh_0723.xlsx")
...
list_files = c("HHData/F4/madeleine_hh_1023.xlsx", "HHData/F4/eric_hh_1023.xlsx", "HHData/F4/marc_hh_1023.xlsx", 
               "HHData/F4/romario_hh_1023.xlsx", "HHData/F4/mahefa_hh_1023.xlsx")
